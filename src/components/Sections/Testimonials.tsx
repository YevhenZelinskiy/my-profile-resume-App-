...
const Testimonials: FC = memo(() => {
  ...
  // const [setParallaxEnabled] = useState(false);
    ...
    <Section noPadding sectionId={SectionId.Testimonials}>
      <div
        className={classNames(
          'flex w-full items-center justify-center bg-cover bg-center lg:px-8',
      ...
      >
        <div className="z-10 w-full max-w-screen-md px-4 lg:px-0">
          <div className="flex flex-col items-center gap-y-6 rounded-xl border-2 border-white p-6 shadow-lg">
            <div
